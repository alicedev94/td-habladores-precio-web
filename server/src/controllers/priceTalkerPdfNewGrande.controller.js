...
// Fuente
const priceTalkerfontSize = 10;
const priceTalkerFontSizePrice = 20;

// -- Contenido estático
const priceTalkerWidthText = 170.07876158; // 221 4,7 cm 
...
const bigNewPriceTalker = async (dataCallback, endCallback, priceTalkerData) => {
      ...
      if (contador == 0) {
        ...
        doc
          ...
          .text(
           product.priceTalkerBrand.toLocaleUpperCase(),
            ...
            94.48820088, // priceTalkerBrandPositionY
            {
        ...
        doc
          ...
          .text(
            ...
            priceTalkerDescriptionPositionY + 8,
            {
              width: priceTalkerWidthText,
              align: "left",
            }
